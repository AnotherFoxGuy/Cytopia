...
void UIElement::setTooltipText(const std::string &text)
{
#ifdef USE_MOFILEREADER
  elementData.tooltipText = moFileLib::moFileReaderSingleton::GetInstance().Lookup(text.c_str());
#else
  elementData.tooltipText = text;
#endif
}
